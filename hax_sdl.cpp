...
void draw_sound(SDL_Surface *surface, int size, int16_t * left_channel,
...
void draw_imaginary_spectrum(SDL_Surface *surface, int size, fftw_complex * spectrum,
...
void draw_real_spectrum(SDL_Surface *surface, int size, fftw_complex * spectrum,
                        int v_position, int height, const char * title,
                        Uint32 pixel) {
    int i;
    float step;
